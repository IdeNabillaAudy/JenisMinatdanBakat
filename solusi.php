...
<body>
    ...
    <main class="batas-atas">
        <div class="card text-white bg-info mb-3">
          <h5 class="card-header">Hasil Identifikasi</h5>
          <div class="card-body text-left ukuran-20">
            ...
            <form method="post" action="solusi.php" enctype="multipart/form-data" role="form">
                ...
                $sql = "SELECT * from tb_profesi WHERE kode_profesi='$kode'";
                            ...
                            <div class="card-body">
                             <form action="solusi.php" method="post">
                              <div class="form-group">
                                <label for="exampleFormControlSelect1">Pilih Jenis Minat Bakat :</label>
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" name="fakta" class="form-control" id="exampleFormControlInput1" placeholder="contoh : Suka berpidato">
                              </div>
